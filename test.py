...
plt.plot(dat1['engine.time'],dat1['membrane.v'], label="1")
...
dat2 = sim2.run(5000)
plt.plot(dat2['engine.time'],dat2['membrane.v'], label="2")
...
sim3.pre(100 * 1000) #pre-pace for 1000 beats
dat3 = sim3.run(1000)

plt.plot(dat3['engine.time'],dat3['membrane.v'], label="3")
plt.legend()
